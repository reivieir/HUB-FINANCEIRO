...
function App() {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    // 1. Atualiza a interface com a mensagem do usuário e limpa o campo
    setMessages((prev) => [...prev, userMessage]);
    setInput('');
    setIsLoading(true);

    try {
      // 2. Chama o serviço da IA que configuramos
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      {/* Messages Area - Mantido original */}
      ...
      {/* Input Area - Corrigido onSubmit e estados */}
