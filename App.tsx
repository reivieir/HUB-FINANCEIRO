        ...
        <div className="max-w-6xl mx-auto animate-slide-up italic">
          <div className="bg-[#121418] rounded-[40px] p-8 border border-gray-800 shadow-2xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
               <div>
                  <h3 className="text-[11px] font-black text-[#D4A373] uppercase mb-4 tracking-widest italic">Dúvidas Frequentes</h3>
               ...
               <div>
                  <h3 className="text-[11px] font-black text-green-500 uppercase mb-4 tracking-widest italic">Comandos & E-mails</h3>
                  <div className="space-y-1 h-[450px] overflow-y-auto pr-4 custom-scrollbar">
